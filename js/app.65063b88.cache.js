...
define('app/app',['require','exports','module','jquery','backbone'],function (require, exports, module) {
...
define('text!tpl/Player.html',[],function () { return '<div class="container">\r\n\t<div class="row" style="color:#fff">\r\n\t\t<div class="col-xs-1 col-md-2 controls">\r\n\t\t\t<div class="row">\r\n\t\t\t\t<div class="col-md-4 visible-md visible-lg" style="padding:0; text-align:right;"><a class="btn disabled previous" title="Previous track"><i class="fa fa-fast-backward" style="vertical-align:middle;"></i></a></div>\r\n\t\t\t\t<div class="col-md-4" style="padding:0"><a class="btn playPause" title="Play/Pause"><i class="fa fa-play fa-2x" style="vertical-align:middle;"></i></a></div>\r\n\t\t\t\t<div class="col-md-4 visible-md visible-lg" style="padding:0;  text-align:left;"><a class="btn next" title="Next track"><i class="fa fa-fast-forward" style="vertical-align:middle;"></i></a></div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div class="col-xs-15 col-md-4 current-track">\r\n\t\t\t<div>\r\n\t\t\t\t<div class="song-info"></div>\r\n\t\t\t\t<div class="song">\r\n\t\t\t\t\t<div class="elapsed">00:00</div>\r\n\t\t\t\t\t<div class="seek">\r\n\t\t\t\t\t\t<input type="range" value="0" min="0" max="1000" class="seek-slider" data-slider-min="0" data-slider-max="1000" data-slider-value="0" />\r\n\t\t\t\t\t\t<div class="seek-loaded"></div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<div class="total">00:00</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div class="col-md-5 playlist visible-md visible-lg">\r\n\t\t\t<ul></ul>\r\n\t\t</div>\r\n\t\t<div class="col-md-1 controls visible-lg">\r\n\t\t\t<a class="btn btn-xs random" title="Random mode"><i class="glyphicon glyphicon-random" style="vertical-align:middle;"></i></a>\r\n\t\t\t<a class="btn btn-xs repeat" title="Repeat mode"><i class="glyphicon glyphicon-retweet" style="vertical-align:middle;"></i></a>\r\n\t\t</div>\r\n\t</div>\r\n</div>';});
...
define('text!tpl/PlayerPlaylistItem.html',[],function () { return '<a class="track" href="/music/<%= track.id %>" title="<%= track.name %>" data-toggle="tooltip">\r\n\t<img src="<%= album.photo %>" class="img-thumbnail" style="height:40px" />\r\n</a>\r\n<a class="delete" aria-hidden="true" title="Remove from playlist" data-toggle="tooltip" data-placement="top">\r\n\t<i class="fa fa-times-circle"></i>\r\n</a>';});

define('app/views/PlayerPlaylistItem',['require','jquery','underscore','backbone','text!tpl/PlayerPlaylistItem.html'],function (require) {
...
define('app/models/song',['require','exports','module','jquery','backbone','app/app'],function (require, exports, module) {
...
define('app/views/Player',['require','jquery','underscore','backbone','text!tpl/Player.html','soundmanager2','slider','display','app/views/PlayerPlaylistItem','app/models/song'],function (require) {
...
define('app/collections/songs',['require','jquery','backbone','app/models/song','app/app'],function (require) {
...
define('text!tpl/SongSmallListItem.html',[],function () { return '<h4>\r\n\t<div class="pull-right"><small><a href="/dj-songs/<% artist.id %>"><%= artist.name %></a></small></div>\r\n\t<a class="play" href="#" title="Play track"><i class="fa fa-play-circle fa-xs"></i></a>\r\n\t<a href="/music/<%= track.id %>"><%= track.name %></a>\r\n\t<small>[<%= track.durationString %>]</small>\r\n</h4>\r\n<li class="divider"></li>';});

define('app/views/SongSmallListItem',['require','jquery','underscore','backbone','text!tpl/SongSmallListItem.html','app/views/Player','display'],function (require) {
...
define('app/views/SongSmallList',['require','jquery','underscore','backbone','app/views/SongSmallListItem'],function (require) {
...
define('text!tpl/Shell.html',[],function () { return '<div id="fb-root"></div>\r\n<script>(function(d, s, id) {\r\n  var js, fjs = d.getElementsByTagName(s)[0];\r\n  if (d.getElementById(id)) return;\r\n  js = d.createElement(s); js.id = id;\r\n  js.src = "//connect.facebook.net/en_US/all.js";\r\n  fjs.parentNode.insertBefore(js, fjs);\r\n}(document, \'script\', \'facebook-jssdk\'));</script>\r\n\r\n<div class="navbar navbar-inverse">\r\n    <div class="container">\r\n        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n        </button>\r\n        <a class="navbar-brand" href="/">\r\n        \t<img src="img/logo/small.7e873dd0.cache.png" alt="DJs Music" />\r\n        </a>\r\n\r\n        <div class="navbar-collapse collapse">\r\n            <ul class="navbar-nav nav">\r\n                <li class="home-menu active"><a href="/">Home</a></li>\r\n                <li class="browse-menu"><a href="/browse">Browse</a></li>\r\n                <li class="people-menu"><a href="/people">People</a></li>\r\n                <li class="login-menu"><a href="/login">Login/Register</a></li>\r\n            </ul>\r\n            <form class="navbar-search navbar-form navbar-right dropdown" action="#browse" method="get">\r\n            \t<div class="form-group has-feedback">\r\n                \t<input id="searchText" type="search" class="search-query dropdown-toggle form-control" placeholder="Search" autocomplete="off" />\r\n\r\n                \t<span class="fa fa-refresh fa-spin form-control-feedback hidden"></span>\r\n                </div>\r\n            </form>\r\n        </div>\r\n        <!--/.nav-collapse -->\r\n    </div>\r\n</div>\r\n\r\n<div class="container" id="main">\r\n\t<div id="content"></div>\r\n\t<footer class="container">\r\n\t\t<p>\r\n\t\t\t<a href="http://twitter.com/djsmusic"><i class="fa fa-twitter"></i></a> /\r\n\t\t\t<a href="https://www.facebook.com/officialdjsmusic" style="color:#4c66a4"><i class="fa fa-facebook"></i></a> /\r\n\t\t\t<a href="http://www.youtube.com/user/djssmusic" style="color:#cc181e"><i class="fa fa-youtube"></i></a> /\r\n\t\t\t<a href="/advertise">Advertise</a> /\r\n\t\t\t<a href="/about">About</a> /\r\n\t\t\t<a href="/technology">Technology</a> /\r\n\t\t\t<a href="/contact">Contact</a>\r\n\t\t\t<br />\r\n\t\t\t<small class="text-muted">&copy; DJs Music (2007-2017) All Rights Reserved &bull; <a href="/privacy">Privacy policy</a> &bull; <a href="/tos">ToS</a></small>\r\n\t\t</p>\r\n\t</footer>\r\n</div>\r\n\r\n<div id="player" class="hidden navbar navbar-inverse navbar-fixed-bottom audio-player"></div>\r\n\r\n<script>\r\n  (function(i,s,o,g,r,a,m){i[\'GoogleAnalyticsObject\']=r;i[r]=i[r]||function(){\r\n  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),\r\n  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)\r\n  })(window,document,\'script\',\'//www.google-analytics.com/analytics.js\',\'ga\');\r\n\r\n  ga(\'create\', \'UA-3181088-6\', \'djs-music.com\');\r\n</script>';});

define('app/views/Shell',['require','jquery','underscore','backbone','app/views/Player','app/collections/songs','app/views/SongSmallList','text!tpl/Shell.html','app/app'],function (require) {
...
define('app/models/user',['require','exports','module','jquery','backbone','app/app'],function (require, exports, module) {
...
define('app/models/Session',['require','exports','module','jquery','backbone','app/app','app/models/user'],function (require, exports, module) {
...
define("nanobar", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Nanobar;
    };
}(this)));

define('app/router',['require','jquery','backbone','app/views/Shell','app/app','app/models/Session','nanobar'],function (require) {
